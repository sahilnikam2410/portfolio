...
export default function NotFound() {
  return (
    <main id="main" tabIndex={-1} className="min-h-viewport relative flex items-center justify-center px-5">
      ...
      <div className="relative w-full max-w-lg border border-[var(--edge-mid)] bg-[var(--surface-raised)]">
        ...
        <div className="px-5 py-6 text-[13px] leading-relaxed">
          ...
          <Link
            href="/"
            className="mt-6 inline-block border border-[var(--edge-strong)] px-4 py-2 text-[var(--color-acid)] transition-colors hover:bg-[rgb(var(--acid-rgb)/0.1)]"
          >
            cd ~
          </Link>
        </div>

    ...
    <AnimatePresence>
      {fired && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 12 }}
          className="fixed bottom-16 left-1/2 z-[75] -translate-x-1/2 border border-[var(--edge-strong)] bg-[var(--surface-raised)] px-5 py-3 text-[12px] text-[var(--color-acid)] shadow-[0_0_40px_rgb(var(--acid-rgb)/0.15)]"
        >

        ...
        <Panel className="p-8 sm:p-12">
          <div className="grid gap-10 md:grid-cols-[1.2fr_0.8fr]">
            <div>
              ...
              <p className="prose-text mt-5 max-w-md text-[14px] leading-relaxed text-[var(--color-prose)]">
              ...
              <div className="mt-8 flex flex-wrap gap-3">
                ...
                <a
                  ...
                  className="border border-[var(--edge-mid)] px-5 py-2.5 text-sm text-[var(--color-bone)] transition-colors hover:border-[var(--color-acid)]"
                >
                  {identity.phone}
                </a>
              ...
              <div className="mt-10">
                ...
                <ul className="grid gap-px border border-[var(--edge)] bg-[rgb(var(--acid-rgb)/0.14)] sm:grid-cols-2">
                  {resumes.map((r) => (
                    <li key={r.file}>
                      <a
                        href={r.file}
                        ...
                        className="flex h-full flex-col justify-between gap-1 bg-[var(--surface-raised)] px-4 py-3 transition-colors hover:bg-[rgb(var(--acid-rgb)/0.08)]"
                      >
            ...
            <ul className="space-y-px self-start border border-[var(--edge)] bg-[rgb(var(--acid-rgb)/0.14)]">
              {socials.map((s) => (
                <li key={s.label}>
                  <a
                    href={s.href}
                    ...
                    rel="noreferrer"
                    className="flex items-center justify-between gap-4 bg-[var(--surface-raised)] px-4 py-3 text-[13px] transition-colors hover:bg-[rgb(var(--acid-rgb)/0.08)]"
                  >

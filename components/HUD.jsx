...
export default function HUD() {
  ...
  return (
    <>
      ...
      <div className="pointer-events-none fixed inset-x-0 top-0 z-[65] h-px bg-[rgba(53,255,158,0.12)]">
        <div
          ref={barRef}
      ...
      {/* left rail */}
      <div className="pointer-events-none fixed bottom-5 left-5 z-[65] hidden select-none flex-col gap-1 text-[10px] uppercase tracking-[0.18em] text-[var(--color-dim)] lg:flex">
        <span>
      ...
      {/* right rail */}
      <div className="pointer-events-none fixed bottom-5 right-5 z-[65] hidden select-none flex-col items-end gap-1 text-[10px] uppercase tracking-[0.18em] text-[var(--color-dim)] lg:flex">
        <span>

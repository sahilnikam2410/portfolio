  ...
  return (
    ...
    >
      ...
      <div className="grid gap-14 sm:gap-20">
        <div className="min-w-0 space-y-7">
          {identity.bio.map((p, i) => (
            <Reveal key={i} delay={i * 0.08}>
              <p className="t-body text-[var(--color-prose)]">{p}</p>
            </Reveal>
          ))}
        ...
        <Reveal delay={0.12}>
          <ol className="relative border-l border-[var(--edge-mid)] pl-6">
            {timeline.map((t, i) => (
              <li key={i} className="mb-8 last:mb-0">
                ...
                <p className="prose-text mt-1.5 text-[13px] leading-relaxed text-[var(--color-prose)]">{t.body}</p>
              </li>
            ))}
          </ol>
        </Reveal>
